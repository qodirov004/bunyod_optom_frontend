...
import { Form, Button, Select, InputNumber, DatePicker, Tag } from 'antd';
...
interface BalonFormProps {
  initialValues?: BalonType;
  onFinish: (values: BalonType) => void;
  onCancel?: () => void;
...
const BalonForm: React.FC<BalonFormProps> = ({
  initialValues,
  onFinish,
  onCancel,
  cars,
  ...
  return (
    ...
    >
      ...
      >
        <Select placeholder="Balon turini tanlang">
          {balonTypes.map(type => (
